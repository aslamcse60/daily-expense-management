...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc())
    {
        ...
        echo "<tr><td> " . $exdate. "</td> <td> " . $row["income"]. " </td><td> " . $row["tvalue"]. "</td> <td> <a href='homedel.php' class='btn btn-sm' name='remove' value='remove'><span class='glyphicon glyphicon-remove white' aria-hidden='true'></span></a></td></tr>";
        $inctotal+=$row["tvalue"];
...
$euser=$_SESSION['unaam'];
$to_email = "mohamedaslamacse@gmail.com";
$subject = "Limit Alert!!!";
$body = "Hi, $euser You have reached your limit.";
$headers = "From: admin@dem.in";
if($rbalance==0){
